      ...
      >
        ...
        <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.4 }} className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-3 flex flex-col">
                    ...
                    <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
                      ...
                      <CollapsibleContent className="space-y-3 mt-2">
                        <div className="flex items-center space-x-2">
                          <Switch id="tp-switch-mobile" checked={takeProfitEnabled} onCheckedChange={setTakeProfitEnabled} />
                        ...
                        <div className="flex items-center space-x-2">
                          <Switch id="sl-switch-mobile" checked={stopLossEnabled} onCheckedChange={setStopLossEnabled} />
            ...
            {/* Active Trades */}
            <Card className="bg-gray-800 border-gray-700 flex flex-col lg:h-48 overflow-y-auto order-3">
              <CardHeader className="p-4 pb-2 flex-shrink-0">
                <CardTitle className="text-sm">Active Trades ({activeTrades.length})</CardTitle>
              </CardHeader>
              <CardContent className="p-2 space-y-3 overflow-y-auto">
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-gray-400 mb-2">
                              {trade.volume} lot • x{trade.leverage} leverage
                            </div>
            ...
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="space-y-4 py-4 px-4">
                ...
                <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
                  ...
                  <CollapsibleContent className="space-y-3 mt-2">
                    <div className="flex items-center space-x-2">
                      <Switch id="tp-switch-desktop" checked={takeProfitEnabled} onCheckedChange={setTakeProfitEnabled} />
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch id="sl-switch-desktop" checked={stopLossEnabled} onCheckedChange={setStopLossEnabled} />
