...
const en: Messages = {
  ...
  selectTickerTitle: "Select a Ticker to View Chart",
  selectTickerDescription: "Choose from the available trading pairs to view real-time charts and technical analysis tools.",
...
const es: Messages = {
  ...
  selectTickerTitle: "Selecciona un símbolo para ver el gráfico",
  selectTickerDescription: "Elige entre los pares disponibles para ver gráficos en tiempo real y herramientas de análisis técnico.",
  updatingChart: "Actualizando datos del gráfico",
