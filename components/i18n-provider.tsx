...
const en: Messages = {
  ...
  couldNotLoadReferrals: "Could not load referrals",
  referralShareMessage: "Join AragonTrade using my referral link and start trading!",
  inviteAndEarn: "Invite & Earn",
  referralHeroTitle: "Invite Friends, Earn Rewards",
  referralHeroSubtitle: "Share your unique link and get bonuses when your friends join and trade",
  invited: "Invited",
  qualified: "Qualified",
  terms: "Terms",
  verifiedPayouts: "Verified Payouts",
  referralRewardSignup: "Get $10 when someone signs up using your link",
  referralRewardDeposit: "Get $40 bonus when they deposit $500+",
  youWillReceiveReward: "You will receive a reward",
  oneRewardPerQualifiedFriend: "One reward per qualified friend",
  totalEarned: "Total Earned",
  whatIsRequiredFromYou: "What is required from you",
  completeVerificationAndKYC: "Complete verification and KYC",
  followPlatformRules: "Follow platform rules",
  withdrawalsAfterVerificationOnly: "Withdrawals after verification only",
  requiredFromFriend: "Required from friend",
  friendMustRegisterWithLink: "Friend must register with your link",
  friendMustVerifyAndDeposit: "Friend must verify and deposit",
  friendMustStartTrading: "Friend must start trading",
  listOfInvited: "List of Invited",
  reward: "Reward",
  bonusEligible: "Bonus Eligible",
  // Admin Settings translations
  platformSettings: "Platform Settings",
  manageStakingPlansAiTradingAndCryptoAddresses: "Manage staking plans, AI-trading tickers, and crypto addresses",
  stakingPlans: "Staking Plans",
  cryptoAddresses: "Crypto Addresses",
  referralRewards: "Referral Rewards",
  withdrawalLimits: "Withdrawal Limits",
  accessDenied: "Access denied. Only owners can access settings.",
  ...
  allAssetsDefaultPlan: "All Assets (Default Plan)",
  defaultStakingPlanForAllAssets: "This will create a default staking plan for all assets in the wallet",
  durationDays: "Duration (days)",
  apr: "APR",
  minimumAmount: "Minimum Amount",
  active: "Active",
  inactive: "Inactive",
  noStakingPlansConfigured: "No staking plans configured. Create your first plan above.",
  confirmDeleteStakingPlan: "Are you sure you want to delete this staking plan?",
  updated: "updated",
  created: "created",
  successfully: "successfully",
  failedToSaveStakingPlan: "Failed to save staking plan",
  stakingPlanDeletedSuccessfully: "Staking plan deleted successfully",
  failedToDeleteStakingPlan: "Failed to delete staking plan",
  aiAnalysisSettings: "AI Analysis Settings",
  configureTimeRangeForAiAnalysis: "Configure the time range for AI analysis (in seconds).",
  minimumTimeSeconds: "Minimum Time (seconds)",
  maximumTimeSeconds: "Maximum Time (seconds)",
  saveSettings: "Save Settings",
  aiTradingTickers: "AI-Trading Tickers",
  selectTickersForAiTrading: "Select tickers that will be used by AI-trading system. Favorites are shown first.",
  aiAnalysisSettingsSavedSuccessfully: "AI analysis settings saved successfully",
  failedToSaveAiAnalysisSettings: "Failed to save AI analysis settings",
  ...
  noCryptoAddressesConfigured: "No crypto addresses configured. Add your first address above.",
  ...
  egUserSignsUp: "e.g., User signs up",
  rewardAmount: "Reward Amount",
  threshold: "Threshold",
  eg500: "e.g., 500",
  descriptionOptional: "Description (optional)",
  additionalDetailsAboutReward: "Additional details about this reward",
  noReferralRewardsConfigured: "No referral rewards configured. Create your first reward above.",
  confirmDeleteReward: "Are you sure you want to delete this reward?",
  rewardDeletedSuccessfully: "Reward deleted successfully",
  failedToSaveReward: "Failed to save reward",
  failedToDeleteReward: "Failed to delete reward",
  addLimit: "Add Limit",
  withdrawalLimit: "Withdrawal Limit",
  selectMethod: "Select method",
  minAmount: "Min Amount",
  maxAmountOptional: "Max Amount (optional)",
  dailyLimitOptional: "Daily Limit (optional)",
  monthlyLimitOptional: "Monthly Limit (optional)",
  fixedFee: "Fixed Fee",
  feePercentOptional: "Fee Percent (optional)",
  processingTimeOptional: "Processing Time (optional)",
  eg13BusinessDays: "e.g., 1-3 business days",
  noWithdrawalLimitsConfigured: "No withdrawal limits configured. Create your first limit above.",
  limit: "Limit",
  min: "Min",
  max: "Max",
  fee: "Fee",
  daily: "Daily",
  monthly: "Monthly",
  confirmDeleteLimit: "Are you sure you want to delete this limit?",
  limitDeletedSuccessfully: "Limit deleted successfully",
  failedToSaveLimit: "Failed to save limit",
  failedToDeleteLimit: "Failed to delete limit",
  profile: "Profile",
  trader: "Trader",
  idLabel: "ID",
  aiTrade: "AI Trade",
  ...
  creditLine: "Credit Balance",
  backToDashboard: "Back to Dashboard",
  manageYourAssets: "Manage Your Assets",
  startVerification: "Start Verification",
  manageReferrals: "Manage Referrals",
  memberSinceLabel: "Member Since",
  reset: "Reset",
  verificationPendingShort: "Verification Pending",
  currentStatus: "Current Status",
  viewYourCompleteTransactionHistory: "View your complete transaction history",
  STATUS: "STATUS",
  reference: "Reference",
  ...
  ofTradeProfits: "of trade profits",
  shareYourReferralCode: "Share your referral link or code",
  friendMustSignupWithCode: "Your friend must register using your link/code",
  earnFromTheirProfits: "Earn commission from each of their profitable trades automatically",
  youEarnFromProfits: "You earn commission from their trading profits",
  copyLink: "Copy Link",
  share: "Share",
  ...
  wallet: {
    ...
    history: {
      ...
      subtitle: "View your wallet transaction history",
      date: "Date",
      type: "Type",
      asset: "Asset",
      amount: "Amount",
  ...
  orderHistoryDescription: "View your deposit, withdrawal, referral bonus, and credit transactions",
  ...
  selectTickerTitle: "Select a symbol",
  selectTickerDescription: "Choose a symbol from the list to display the chart.",
  realtimeWithDrawings: "Realtime with drawings",
  liveMarket: "LIVE",
  ...
  footer: {
    platform: "Platform",
    platformDescription: "Aragon Trade provides multi-asset CFD trading with deep liquidity, fast execution and institutional-grade risk management tools.",
    tradingTerminal: "Trading terminal",
    walletBalances: "Wallet & balances",
    referralProgram: "Referral program",
    legal: "Legal",
    riskWarning: "Trading CFDs and other leveraged products involves a high level of risk and may not be suitable for all investors. You can lose more than your initial investment. Do not trade with funds you cannot afford to lose.",
  },
  // Common
  loading: "Loading...",
  error: "Error",
  ...
  // Profile pages
  inviteFriendsAndEarnRewards: "Invite friends and earn rewards",
  transferFundsToAccount: "Transfer funds to your account or another user",
  loadingWithdrawalOptions: "Loading withdrawal options...",
  missingInformation: "Missing information",
  pleaseEnterUserEmail: "Please enter user email for transfer",
  pleaseEnterCryptoAddress: "Please enter crypto address and network",
  pleaseEnterCardDetails: "Please enter card details",
  pleaseFillAllRequiredFields: "Please fill all required fields",
  pleaseEnterValidAmount: "Please enter a valid amount",
  failedToLoadWithdrawalData: "Failed to load withdrawal data",
  selectedMethodNotAvailable: "Selected withdrawal method is not available",
  amountTooLowTitle: "Amount too low",
  amountTooHighTitle: "Amount too high",
  ...
  withdrawalRequestProcessing: "Your withdrawal request is being processed",
  ...
  selectAsset: "Select Asset",
  important: "Important",
  sendOnlyTokenWarning: "Send only {token} to this address. Sending other cryptocurrencies may result in permanent loss.",
  ...
  aiTradingPoweredBy: "Powered by advanced neural networks trained on",
  aiTrading10Years: "10+ years",
  aiTradingOfMarketData: "of market data",
  aiTrading2016Tickers: "2,016 Tickers",
  aiTradingTerabytes: "Terabytes of Data",
  aiTrading94Accuracy: "94% Accuracy",
  aiTradingDataAnalysis: "Data Analysis",
  aiTradingDataAnalysisDesc: "Our AI analyzes",
  aiTradingDataAnalysisDesc2: "of historical market data across",
  aiTradingDataAnalysisDesc3: "identifying patterns and trends that human traders might miss.",
  aiTradingTechnicalIndicators: "Technical Indicators",
  aiTradingTechnicalIndicatorsDesc: "Advanced technical indicators including",
  aiTrading94AccuracyTitle: "94% Accuracy",
  aiTrading94AccuracyDesc: "94% accuracy rate",
  aiTradingBetaMessage: "Congratulations! You're in Beta",
  aiTradingBetaDesc: "You're among the first to experience our revolutionary AI trading system.",
  aiTradingBetaDesc2: "Help us improve by providing feedback and enjoy early access to cutting-edge technology.",
  aiTradingBetaTest: "Beta Test",
  aiTradingTechnicalIndicatorsDesc2: "Bollinger Bands, and custom algorithms work together to provide comprehensive market insights.",
  aiTrading94AccuracyDescFull: "After processing",
  aiTradingMillionsDataPoints: "millions of data points",
  aiTrading94AccuracyDescFull2: "our neural network delivers trade recommendations with an impressive",
  wins: "Wins",
  losses: "Losses",
  total: "Total",
  scrollToExplore: "Scroll to explore",
  aiTradingTryNow: "Try AI Trading Now",
  username: "Username",
...
const es: Messages = {
  ...
  wallet:{
    ...
    history: {
      ...
      subtitle: "Ver el historial de transacciones de tu cartera",
      date: "Fecha",
      type: "Tipo",
      asset: "Activo",
      amount: "Cantidad",
  ...
  orderHistoryDescription: "Vea sus depósitos, retiros, bonos de referidos y transacciones de crédito",
  searchOrders: "Buscar órdenes...",
  allStatus: "Todos los Estados",
  allTypes: "Todos los Tipos",
  completed: "Completado",
  referralBonus: "Bono de Referido",
  creditGrant: "Concesión de Crédito",
  ...
  selectTickerTitle: "Seleccionar un símbolo",
  selectTickerDescription: "Elija un símbolo de la lista para mostrar el gráfico.",
  realtimeWithDrawings: "En tiempo real con dibujos",
  liveMarket: "EN VIVO",
  ...
  footer: {
    platform: "Plataforma",
    platformDescription: "Aragon Trade ofrece trading de CFD multi-activos con alta liquidez, ejecución rápida y herramientas de gestión de riesgos de nivel institucional.",
    tradingTerminal: "Terminal de trading",
    walletBalances: "Cartera y balances",
    referralProgram: "Programa de referidos",
    legal: "Legal",
    riskWarning: "El trading de CFD y otros productos apalancados implica un alto nivel de riesgo y puede no ser adecuado para todos los inversores. Puedes perder más que tu inversión inicial. No operes con fondos que no puedas permitirte perder.",
  },
  // Common
  loading: "Cargando...",
  error: "Error",
  ...
  refresh: "Actualizar",
  // Profile pages
  inviteFriendsAndEarnRewards: "Invita amigos y gana recompensas",
  transferFundsToAccount: "Transfiere fondos a tu cuenta o a otro usuario",
  loadingWithdrawalOptions: "Cargando opciones de retiro...",
  missingInformation: "Información faltante",
  // Referral system translations (Spanish)
  couldNotLoadReferrals: "No se pudieron cargar las referencias",
  referralShareMessage: "¡Únete a AragonTrade usando mi enlace de referencia y comienza a operar!",
  inviteAndEarn: "Invita y Gana",
  referralHeroTitle: "Invita Amigos, Gana Recompensas",
  referralHeroSubtitle: "Comparte tu enlace único y obtén bonos cuando tus amigos se unan y operen",
  invited: "Invitados",
  qualified: "Calificados",
  terms: "Términos",
  verifiedPayouts: "Pagos Verificados",
  referralRewardSignup: "Obtén $10 cuando alguien se registre usando tu enlace",
  referralRewardDeposit: "Obtén un bono de $40 cuando depositen $500+",
  youWillReceiveReward: "Recibirás una recompensa",
  oneRewardPerQualifiedFriend: "Una recompensa por amigo calificado",
  totalEarned: "Total Ganado",
  whatIsRequiredFromYou: "Qué se requiere de ti",
  completeVerificationAndKYC: "Completar verificación y KYC",
  followPlatformRules: "Seguir las reglas de la plataforma",
  withdrawalsAfterVerificationOnly: "Retiros solo después de la verificación",
  requiredFromFriend: "Requerido del amigo",
  friendMustRegisterWithLink: "El amigo debe registrarse con tu enlace",
  friendMustVerifyAndDeposit: "El amigo debe verificar y depositar",
  friendMustStartTrading: "El amigo debe comenzar a operar",
  listOfInvited: "Lista de Invitados",
  reward: "Recompensa",
  bonusEligible: "Elegible para Bono",
  // Admin Settings translations (Spanish)
  platformSettings: "Configuración de la Plataforma",
  manageStakingPlansAiTradingAndCryptoAddresses: "Gestiona planes de staking, tickers de AI-trading y direcciones cripto",
  stakingPlans: "Planes de Staking",
  cryptoAddresses: "Direcciones Cripto",
  referralRewards: "Recompensas de Referidos",
  withdrawalLimits: "Límites de Retiro",
  accessDenied: "Acceso denegado. Solo los propietarios pueden acceder a la configuración.",
  addStakingPlan: "Agregar Plan de Staking",
  edit: "Editar",
  create: "Crear",
  stakingPlan: "Plan de Staking",
  planName: "Nombre del Plan",
  selectAsset: "Seleccionar Activo",
  allAssetsDefaultPlan: "Todos los Activos (Plan por Defecto)",
  defaultStakingPlanForAllAssets: "Esto creará un plan de staking por defecto para todos los activos en la cartera",
  durationDays: "Duración (días)",
  apr: "APR",
  minimumAmount: "Cantidad Mínima",
  active: "Activo",
  inactive: "Inactivo",
  noStakingPlansConfigured: "No hay planes de staking configurados. Crea tu primer plan arriba.",
  confirmDeleteStakingPlan: "¿Estás seguro de que quieres eliminar este plan de staking?",
  updated: "actualizado",
  created: "creado",
  successfully: "exitosamente",
  failedToSaveStakingPlan: "Error al guardar el plan de staking",
  stakingPlanDeletedSuccessfully: "Plan de staking eliminado exitosamente",
  failedToDeleteStakingPlan: "Error al eliminar el plan de staking",
  aiAnalysisSettings: "Configuración de Análisis IA",
  configureTimeRangeForAiAnalysis: "Configura el rango de tiempo para el análisis IA (en segundos).",
  minimumTimeSeconds: "Tiempo Mínimo (segundos)",
  maximumTimeSeconds: "Tiempo Máximo (segundos)",
  saveSettings: "Guardar Configuración",
  aiTradingTickers: "Tickers de AI-Trading",
  selectTickersForAiTrading: "Selecciona tickers que serán usados por el sistema de AI-trading. Los favoritos se muestran primero.",
  aiAnalysisSettingsSavedSuccessfully: "Configuración de análisis IA guardada exitosamente",
  failedToSaveAiAnalysisSettings: "Error al guardar la configuración de análisis IA",
  addAddress: "Agregar Dirección",
  cryptoAddress: "Dirección Cripto",
  token: "Token",
  selectToken: "Seleccionar Token",
  network: "Red",
  selectNetwork: "Seleccionar Red",
  noCryptoAddressesConfigured: "No hay direcciones cripto configuradas. Agrega tu primera dirección arriba.",
  addressDeletedSuccessfully: "Dirección eliminada exitosamente",
  ...
  failedToDeleteAddress: "Error al eliminar la dirección",
  addReward: "Agregar Recompensa",
  referralReward: "Recompensa de Referido",
  actionType: "Tipo de Acción",
  selectAction: "Seleccionar acción",
  userSignsUp: "Usuario se Registra",
  firstDeposit: "Primer Depósito",
  depositThreshold: "Umbral de Depósito",
  firstTrade: "Primera Operación",
  tradeVolume: "Volumen de Operaciones",
  actionLabel: "Etiqueta de Acción",
  egUserSignsUp: "ej., Usuario se registra",
  rewardAmount: "Cantidad de Recompensa",
  threshold: "Umbral",
  eg500: "ej., 500",
  descriptionOptional: "Descripción (opcional)",
  additionalDetailsAboutReward: "Detalles adicionales sobre esta recompensa",
  noReferralRewardsConfigured: "No hay recompensas de referidos configuradas. Crea tu primera recompensa arriba.",
  confirmDeleteReward: "¿Estás seguro de que quieres eliminar esta recompensa?",
  rewardDeletedSuccessfully: "Recompensa eliminada exitosamente",
  failedToSaveReward: "Error al guardar la recompensa",
  failedToDeleteReward: "Error al eliminar la recompensa",
  addLimit: "Agregar Límite",
  withdrawalLimit: "Límite de Retiro",
  selectMethod: "Seleccionar método",
  minAmount: "Cantidad Mín",
  maxAmountOptional: "Cantidad Máx (opcional)",
  dailyLimitOptional: "Límite Diario (opcional)",
  monthlyLimitOptional: "Límite Mensual (opcional)",
  fixedFee: "Tarifa Fija",
  feePercentOptional: "Porcentaje de Tarifa (opcional)",
  processingTimeOptional: "Tiempo de Procesamiento (opcional)",
  eg13BusinessDays: "ej., 1-3 días hábiles",
  noWithdrawalLimitsConfigured: "No hay límites de retiro configurados. Crea tu primer límite arriba.",
  limit: "Límite",
  min: "Mín",
  max: "Máx",
  fee: "Tarifa",
  daily: "Diario",
  monthly: "Mensual",
  confirmDeleteLimit: "¿Estás seguro de que quieres eliminar este límite?",
  limitDeletedSuccessfully: "Límite eliminado exitosamente",
  failedToSaveLimit: "Error al guardar el límite",
  failedToDeleteLimit: "Error al eliminar el límite",
  profile: "Perfil",
  trader: "Trader",
  idLabel: "ID",
  aiTrade: "Operación IA",
  ofTradeProfits: "de ganancias de trading",
  shareYourReferralCode: "Comparte tu enlace o código de referido",
  friendMustSignupWithCode: "Tu amigo debe registrarse usando tu enlace/código",
  earnFromTheirProfits: "Gana comisión de cada una de sus operaciones rentables automáticamente",
  yourReferralCode: "Tu Código de Referido",
  referralRewardTrade: "Gana 7% de las ganancias de trading de tus referidos automáticamente",
  noReferralsYet: "Aún no hay referidos",
  shareYourLinkToStartEarning: "Comparte tu enlace para comenzar a ganar",
  eligible: "Elegible",
  notEligible: "No Elegible",
  unnamed: "Sin nombre",
  copy: "Copiar",
  copied: "Copiado",
  youEarnFromProfits: "Ganas comisión de sus ganancias de trading",
  pleaseEnterUserEmail: "Por favor ingrese el correo electrónico del usuario para la transferencia",
  pleaseEnterCryptoAddress: "Por favor ingrese la dirección cripto y la red",
  pleaseEnterCardDetails: "Por favor ingrese los detalles de la tarjeta",
  ...
  failedToLoadWithdrawalData: "No se pudieron cargar los datos de retiro",
  selectedMethodNotAvailable: "El método de retiro seleccionado no está disponible",
  amountTooLowTitle: "Monto demasiado bajo",
  amountTooHighTitle: "Monto demasiado alto",
  dailyLimitExceededTitle: "Límite diario excedido",
  insufficientFundsTitle: "Fondos insuficientes",
  minimumAmountIs: "El monto mínimo es",
  maximumAmountIs: "El monto máximo es",
  dailyLimitIs: "El límite diario es",
  enterAmount: "Ingresa el monto",
  withdrawalMethod: "Método de Retiro",
  businessDays1to3: "1-3 días hábiles",
  withdrawToCryptoAddress: "Retirar a una dirección cripto",
  cardHolderName: "Nombre del titular",
  enterCardHolderName: "Ingresa el nombre del titular",
  enterCardNumber: "Ingresa el número de tarjeta",
  selectCryptoAsset: "Selecciona activo cripto",
  enterCryptoAddress: "Ingresa la dirección cripto",
  withdrawalRequestSubmitted: "Solicitud de retiro enviada",
  withdrawalRequestProcessing: "Su solicitud de retiro está siendo procesada",
  submissionFailed: "Envío fallido",
  couldNotProcessWithdrawal: "No se pudo procesar el retiro",
  networkErrorOccurred: "Ocurrió un error de red",
  withdrawalForm: "Formulario de Retiro",
  selectAsset: "Seleccionar Activo",
  important: "Importante",
  sendOnlyTokenWarning: "Envíe solo {token} a esta dirección. Enviar otras criptomonedas puede resultar en pérdida permanente.",
  youWillReceive: "Recibirás",
  availableFunds: "Fondos Disponibles",
  noFundsAvailable: "No hay fondos disponibles para retiro",
  available: "Disponible",
  ...
  manageYourAssets: "Gestiona tus Activos",
  viewYourTransactionHistory: "Ver tu historial de transacciones",
  accountBalance: "Saldo de Cuenta",
  accountVerified: "Cuenta Verificada",
  walletOverview: "Resumen de Cartera",
  creditLine: "Saldo de Crédito",
  backToDashboard: "Volver al Panel",
  uploadFrontId: "Subir anverso de ID",
  uploadBackId: "Subir reverso de ID",
  ...
  manageReferrals: "Gestionar Referidos",
  memberSinceLabel: "Miembro Desde",
  reset: "Restablecer",
  verificationPendingShort: "Verificación Pendiente",
  currentStatus: "Estado Actual",
  viewYourCompleteTransactionHistory: "Ver tu historial completo de transacciones",
  STATUS: "ESTADO",
  // AI Trading page
  aiTrading: "Trading con IA",
  aiTradingPoweredBy: "Impulsado por redes neuronales avanzadas entrenadas en",
  aiTrading10Years: "10+ años",
  aiTradingOfMarketData: "de datos de mercado",
  aiTrading2016Tickers: "2,016 Tickers",
  aiTradingTerabytes: "Terabytes de Datos",
  aiTrading94Accuracy: "94% Precisión",
  aiTradingDataAnalysis: "Análisis de Datos",
  aiTradingDataAnalysisDesc: "Nuestra IA analiza",
  aiTradingDataAnalysisDesc2: "de datos históricos de mercado en",
  aiTradingDataAnalysisDesc3: "identificando patrones y tendencias que los traders humanos podrían pasar por alto.",
  aiTradingTechnicalIndicators: "Indicadores Técnicos",
  aiTradingTechnicalIndicatorsDesc: "Indicadores técnicos avanzados incluyendo",
  aiTrading94AccuracyTitle: "94% Precisión",
  aiTrading94AccuracyDesc: "tasa de precisión del 94%",
  aiTradingBetaMessage: "¡Felicidades! Estás en Beta",
  aiTradingBetaDesc: "Eres uno de los primeros en experimentar nuestro revolucionario sistema de trading con IA.",
  aiTradingBetaDesc2: "Ayúdanos a mejorar proporcionando comentarios y disfruta del acceso anticipado a tecnología de vanguardia.",
  aiTradingBetaTest: "Prueba Beta",
  aiTradingTechnicalIndicatorsDesc2: "Bollinger Bands y algoritmos personalizados trabajan juntos para proporcionar insights completos del mercado.",
  aiTrading94AccuracyDescFull: "Después de procesar",
  aiTradingMillionsDataPoints: "millones de puntos de datos",
  aiTrading94AccuracyDescFull2: "nuestra red neuronal entrega recomendaciones de trading con una impresionante",
  wins: "Victorias",
  losses: "Pérdidas",
  scrollToExplore: "Desplázate para explorar",
  aiTradingTryNow: "Prueba Trading con IA Ahora",
  ...
  manageYourPreferences: "Gestiona tus preferencias",
  ...
  admin: {
    ...
    trades: "Operaciones",
    orders: "Órdenes",
    createTrade: "Crear Operación",
    createOrder: "Crear Orden",
    editTrade: "Editar Operación",
    editOrder: "Editar Orden",
    newTrade: "Crear Nueva Operación",
    newOrder: "Crear Nueva Orden",
    userUpdated: "Usuario actualizado exitosamente",
    userUpdateFailed: "Error al actualizar usuario",
    tradeCreated: "Operación creada exitosamente",
    tradeCreateFailed: "Error al crear operación",
    orderCreated: "Orden creada exitosamente",
    orderCreateFailed: "Error al crear orden",
    profitUpdated: "Beneficio actualizado exitosamente",
    profitUpdateFailed: "Error al actualizar beneficio",
    walletUpdated: "Cartera actualizada exitosamente",
    walletUpdateFailed: "Error al actualizar cartera",
    asset: "Activo",
    currentBalance: "Balance actual",
    balance: "Balance",
    credit: "Crédito",
    creditBalance: "Saldo de Crédito",
    enterCreditLimit: "Ingrese límite de crédito",
    enterCreditUsed: "Ingrese crédito usado",
    updating: "Actualizando...",
    updateWallet: "Actualizar Cartera",
    adding: "Agregando",
    subtracting: "Restando",
    setting: "Estableciendo",
    newBalance: "Nuevo balance",
    clickToAddOrSubtract: "Haga clic en + para agregar o - para restar del balance, o ingrese el valor directamente para establecer",
    enterNewBalance: "Ingrese nuevo balance",
    amountToAdd: "Cantidad a agregar",
    amountToSubtract: "Cantidad a restar",
    orderType: "Tipo de Orden",
    bankAccount: "Cuenta Bancaria",
    referral: "Referido",
    totalUsers: "Total de Usuarios",
    registeredUsers: "Usuarios registrados",
    platformBalance: "Balance de la plataforma",
    activeTrades: "Operaciones Activas",
    ...
    failedToLoadStats: "Error al cargar estadísticas del panel",
    total: "total",
    loadingTrades: "Cargando operaciones...",
    noTradesYet: "Aún no hay operaciones",
    loadingOrders: "Cargando órdenes...",
    noOrdersYet: "Aún no hay órdenes",
    failedToLoadWallet: "Error al cargar datos de la cartera",
    comments: "Comentarios",
    saveComments: "Guardar Comentarios",
    commentsSaved: "Comentarios guardados exitosamente",
    commentsSaveFailed: "Error al guardar comentarios",
    assignUser: "Asignar Usuario",
    connectReferral: "Conectar Referido",
    refreshWalletData: "Actualizar Datos de Cartera",
    chat: "Chat",
    favorite: "Favorito",
    unfavorite: "Quitar de favoritos",
    walletOverview: "Resumen de Cartera",
    walletAssets: "Activos de Cartera",
    quickActions: "Acciones Rápidas",
    searchOrders: "Buscar órdenes...",
    allStatus: "Todos los Estados",
    allTypes: "Todos los Tipos",
    ...
    orderHistory: "Historial de Órdenes",
    viewDepositWithdrawal: "Vea sus depósitos, retiros, bonos de referidos y transacciones de crédito",
    availableBalance: "Balance Disponible",
    failedToLoadOrders: "Error al cargar órdenes",
    saving: "Guardando...",
    addCommentsPlaceholder: "Agregue sus comentarios aquí...",
    type: "Tipo",
    assetType: "Tipo de Activo",
    ticker: "Ticker",
    searchTickers: "Buscar tickers...",
    noTickersAvailable: "No hay tickers disponibles",
    volume: "Volumen",
    leverage: "Apalancamiento",
    margin: "Margen",
    openPrice: "Precio de Apertura",
    takeProfit: "Take Profit (Opcional)",
    stopLoss: "Stop Loss (Opcional)",
    status: "Estado",
    amount: "Cantidad",
    buy: "Comprar",
    sell: "Vender",
    ...
    assign: "Asignar",
    refresh: "Actualizar",
    noWalletAssetsFound: "No se encontraron activos de cartera",
    pleaseSelectAsset: "Por favor seleccione un activo",
    pleaseEnterBalance: "Por favor ingrese un valor de balance",
    pleaseEnterCreditLimit: "Por favor ingrese un límite de crédito",
    invalidBalanceValue: "Valor de balance inválido",
    success: "Éxito",
    error: "Error",
  },
};
