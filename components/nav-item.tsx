...
import {ChartCandlestickIcon, ListIcon, LucideWalletCards, Newspaper, Sparkles} from "lucide-react";
...
const NavItem = ({mobile = false }) => {
    ...
    // Add AI Trading if user has access
    if (hasAITrading) {
        routes.push({ 
            name: "AI Trading", 
            href: "/ai-trading", 
            icon: <Sparkles className={'w-5 h-5 md:w-6 md:h-6 '}/>, 
            color:"hover:bg-gradient-to-t hover:from-purple-400 hover:via-gray-900 hover:to-gray-900", 
            bg:"bg-gradient-to-t from-purple-500 via-gray-900 to-gray-900"
        });
    }
