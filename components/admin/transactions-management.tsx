...
import { tickerMetaMap, TickerMeta } from "@/data/ticker-meta"
...
export default function TransactionsManagement() {
    ...
    const filteredTrades = trades.filter((trade) => {
        ...
        const tickerMeta = tickerMetaMap.get(trade.ticker)
        const displayName = tickerMeta?.showName || trade.ticker
        ...
        <div className="space-y-4 px-2 sm:space-y-6 sm:px-0">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
                ...
                {tradesToShow.map((trade) => {
                    ...
                    const tickerInfo = tickerMetaMap.get(trade.ticker)
                                    ...
                                    <div className="flex min-w-0 flex-1 flex-col justify-center">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-semibold text-slate-100 sm:text-base">
                                                {tickerInfo?.showName || trade.ticker}
                                            </span>
                                            <Badge
                        ...
                        <div className="space-y-3 text-sm sm:space-y-4">
                            <div>
                                ...
                                <div className="mt-1 flex items-center gap-2 text-slate-100">
                                    {(() => {
                                        const tickerInfo = tickerMetaMap.get(selectedTrade.ticker)
                                        return (
                                            <>
                                                {tickerInfo && (
                                                    <TickerAvatar
                                                ...
                                                {tickerInfo?.showName || selectedTrade.ticker}
                                            </>
                                        )
                                    })()}
                                </div>
