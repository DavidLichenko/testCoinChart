...
import NavContainerMobile from "@/components/NavContainerMobile";
...
function Trade () {
    ...
    return (
        <>
            <div className={`w-full ${isMobile ? 'h-full bg-background' :'h-screen'}`}>
                {loading ?
                    <>
                            ...
                            <>
                                <div
                                    ...
                                    <div className="flex gap-4 items-center mr-4">
                                        ...
                                        <ThemeSwitcher/>
                                        <NavigationMenu onTabChange={setActiveTab}/>
                                    </div>
                                ...
                                <div className="flex flex-col h-full w-full gap-4">
                                    <nav
                                        ...
                                        <div className="flex gap-4 items-center">
                                            ...
                                            <div>
                                                <Button disableRipple={true} variant={'bordered'} radius={'none'}
                                                        content={'asdasd'} size={'md'} className='text-lg font-bold pl-6 pr-3'>
                                                    <div className='flex flex-col'>
                                                        <div className='flex flex-row items-center justify-between w-full'>
                                                            {userBalance ?
                                    ...
                                    <div className="w-full h-full mx-auto relative flex items-stretch justify-center">
                                        ...
                                        <div className='flex flex-col gap-3 mr-3  w-full h-full items-center justify-center'>
                                            <div
                                                className="flex flex-rowborder-border gap-4 w-full h-full items-center justify-center">
                                                {!loadingChartData
                                                    ?
                                                    // <ChartElement chartData={chartData} ticker={ticker}/>
                                                    <div ref={chartHeightDiv} className="basis-full h-[70vh] bg-secondary z-50"
                                                         id={'Chart'}>
                                                        <Chart ticker={ticker} tickerType={tickerType[0]}
                                                               sendCurrentPrice={currentPriceFromChart} OpenIn={openIn}
                                                               CloseIn={closeIn} addTPPriceLine={TPPrice}
                                                               addSLPriceLine={SLPrice} currentHeight={chartHeight}/>
                                                    </div>
                                                    : <Skeleton
